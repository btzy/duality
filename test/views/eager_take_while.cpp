...
TEST_CASE("finite eager_take view of random_access_bidirectional_view", "[view eager_take_while]") {
    std::vector<int> vec{1, 2, 3, 4, 5};
    auto v = viewify(vec);
    static_assert(std::same_as<view_element_type_t<decltype(v)>, int&>);
    view_assert_random_access_bidirectional(views::eager_take(v, 3), {1, 2, 3});
    view_assert_random_access_bidirectional(v | views::eager_take(3), {1, 2, 3});
    view_assert_random_access_bidirectional(std::vector<int>{1, 2, 3, 4, 5} | views::eager_take(3),
                                            {1, 2, 3});
    ...
    view_assert_random_access_bidirectional(std::vector<int>{1, 2, 3, 4, 5} | views::eager_take(8),
                                            {1, 2, 3, 4, 5});
    ...
    view_assert_random_access_bidirectional(std::vector<int>{1, 2, 3, 4, 5} | views::eager_take(0),
                                            {});
    ...
    view_assert_random_access_bidirectional(factories::empty<int>() | views::eager_take(3), {});
    view_assert_emptyness(factories::empty<int>() | views::eager_take(3), {});
    view_assert_sized(factories::empty<int>() | views::eager_take(3), {});
    view_assert_random_access_bidirectional(factories::empty<int>() | views::eager_take(0), {});
    view_assert_emptyness(factories::empty<int>() | views::eager_take(0), {});
    view_assert_sized(factories::empty<int>() | views::eager_take(0), {});
    view_assert_random_access_bidirectional(factories::single(100) | views::eager_take(3), {100});
    ...
    view_assert_random_access_bidirectional(factories::single(100) | views::eager_take(0), {});
    view_assert_emptyness(factories::single(100) | views::eager_take(0), {});
    view_assert_sized(factories::single(100) | views::eager_take(0), {});
}

TEST_CASE("finite eager_take view of multipass_forward_view", "[view eager_take_while]") {
...
TEST_CASE("finite eager_take view of infinite random_access_bidirectional_view",
          "[view eager_take_while]") {
    view_assert_random_access_bidirectional(
        factories::iota(static_cast<size_t>(0)) | views::eager_take(3), {0, 1, 2});
    view_assert_emptyness(factories::iota(static_cast<size_t>(0)) | views::eager_take(3),
                          {0, 1, 2});
    view_assert_random_access_bidirectional(
        factories::iota(static_cast<size_t>(0)) | views::eager_take(0), {});
